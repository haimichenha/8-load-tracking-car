...
| --- | --- | --- |
| Primary local guidance is gray tracking | Confirmed | Use mux address outputs AD0/AD1/AD2 on PC0/PC1/PC2 plus selected OUT on PG0 in every competition image; X1-X8, white/black polarity, and X4/X5 error sign are verified |
...
| First field line-follow image uses PG10 and frozen logs | One lap passed; A auto-stop pending | `LineFollowJY901Debug` completed one physical lap at 600 mm/s nominal speed with fresh direct JY901 and frozen evidence. It was manually stopped because the curved A-end marker did not sustain stable `0xFF`; repair the terminal-marker policy and repeat before increasing speed |
